 ...
 * - Azure Voice Live for real-time speech and viseme events
 *
          ...
          {modelNotFound ? (
            ...
            >
              ...
              <p style={{ margin: '16px 0 0 0', fontSize: '12px', opacity: 0.7 }}>
                See{' '}
                <a
                  href="https://github.com/iloveagents/azure-voice-live/tree/main/packages/react#live2d-avatar-setup"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: '#a5d6ff' }}
                >
